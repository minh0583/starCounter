  ...
  grunt.initConfig({
    replace: {
      date: {
        ...
        files: [
          {src: ['src/UserAdmin/package/package.config'], dest: './'}
        ]
      },
      scversion: {
        options: {
    ...
    bump: {
      options: {
        files: ['package.json', 'src/UserAdmin/package/package.config'],
        commit: true,
        commitMessage: '%VERSION%',
        commitFiles: ['package.json', 'src/UserAdmin/package/package.config'],
        createTag: true,
        tagName: '%VERSION%',
